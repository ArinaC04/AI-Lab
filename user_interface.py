...
def display(func):
    ...
    T1 = Message(root, text = 'Write here the starting notes for the melody. They should range from C1 to C12')
    T1.grid(row=2)
    ...
    button = Button(root, text='Generate', width=25, command=func)
